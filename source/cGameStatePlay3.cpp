...
cGameStatePlay3::cGameStatePlay3(){
...
void cGameStatePlay3::initialize(){
  m_viewChoice = 0;
  ::ShowCursor(true);
  m_currentSprite = 20;
...
void cGameStatePlay3::activate(CGameData &data){

}
//***************************************************************
//                         U P D A T E
//***************************************************************
cGameStateObject* cGameStatePlay3::update(double timeDifference, Camera &cam, CGameData &data, CGraphics &con){
...
//                         R E N D E R 
//***************************************************************
void cGameStatePlay3::render(CGraphics &con, Camera &cam, CGameData &data){
  CLog *pLog = CLog::Instance();
...
void cGameStatePlay3::processEvent(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam){
}

void cGameStatePlay3::deactivate(){
  CAudioManager *pAudio = CAudioManager::Instance();
  pAudio->KillAll();
//  Delete<psys::PSystem*>( Gun );
  
}
void cGameStatePlay3::resume(){
}
void cGameStatePlay3::pause(){
}
void cGameStatePlay3::save(){
}

void cGameStatePlay3::addTransitionEvent(int event, cGameStateObject* p_Next){
  TRANSITION_EVENT te;
  te.event=event;
  te.p_gso = p_Next;
