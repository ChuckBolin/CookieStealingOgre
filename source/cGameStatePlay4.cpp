...
void cGameStatePlay4::activate(CGameData &data){

}
//***************************************************************
//                         U P D A T E
//***************************************************************
cGameStateObject* cGameStatePlay4::update(double timeDifference, Camera &cam, CGameData &data, CGraphics &con){
  ...
  if(bFirstTime == true){
    ...
    data.LoadGameLevel("data//level4.dat", con);
...
//                         R E N D E R 
//***************************************************************
void cGameStatePlay4::render(CGraphics &con, Camera &cam, CGameData &data){
  CLog *pLog = CLog::Instance();
