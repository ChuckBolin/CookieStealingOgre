...
void cGameStatePlay2::initialize(){
  m_viewChoice = 0;
  ::ShowCursor(true);
  m_currentSprite = 20;
...
void cGameStatePlay2::activate(CGameData &data){
...
void cGameStatePlay2::processEvent(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam){
}
...
void cGameStatePlay2::resume(){
}
void cGameStatePlay2::pause(){
}
void cGameStatePlay2::save(){
}

void cGameStatePlay2::addTransitionEvent(int event, cGameStateObject* p_Next){
  TRANSITION_EVENT te;
  te.event=event;
  te.p_gso = p_Next;
