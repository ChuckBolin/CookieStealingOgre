...
/*
void CGrandma::initialize(){

}*/

void CGrandma::Update(double timeDifference){
  ...
  //don't move grandma unless player is close
  if(range > 400){
    speed = 0;
    return;
  }

  //here's some basic AI
...
/*
CGrandma& CGrandma::operator =(const CGrandma& rhs){
  if(this == &rhs)
    return *this;
...
void CGrandma::UpdatePlayerPosition(float x, float y){
  playerPos.x = x;
  playerPos.y = y;
}