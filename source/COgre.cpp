...
/*
void COgre::initialize(){

}*/

void COgre::Update(double timeDifference){
...
/*
COgre& COgre::operator =(const COgre& rhs){
  if(this == &rhs)
    return *this;
...
void COgre::UpdatePlayerPosition(float x, float y){
  playerPos.x = x;
  playerPos.y = y;
}